...
app.post('/sendmail', function(req, res){
  ...
  if (req.body && req.body.pdf){
    ...
    mailOptions = {
        ...
        bcc: 'info@itncentraloklahoma.org'
    };
    ...
    MongoClient.connect('mongodb://itnadmin:itnUser0136!@ds153700.mlab.com:53700/itncentraloklahoma', function(err, client) {
      if (err) { 
        console.log('db not connecting, but inside mongo block', err);
      };
      db = client.db('itncentraloklahoma');
